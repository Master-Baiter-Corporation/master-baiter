...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Test audio file with Coral-compatible models")
    ...
    models_to_test = [
        ...
        ("Pruning 70% + INT8 (Coral)", MODELS_DIR / "model_pruned_70_int8_edgetpu.tflite"),
    ]
    ...
    print("\n" + "="*70)
    print("BENCHMARK GOOGLE CORAL (Edge TPU)")
    print("="*70)
    ...
    for i, (name, model_path) in enumerate(models_to_test):
        ...
        try:
            interpreter = load_coral_tflite(model_path)
